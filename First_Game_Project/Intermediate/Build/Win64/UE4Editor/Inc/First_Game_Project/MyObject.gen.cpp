...
#include "First_Game_Project/MyObject.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRST_GAME_PROJECT_API UClass* Z_Construct_UClass_UMyObject_NoRegister();
	FIRST_GAME_PROJECT_API UClass* Z_Construct_UClass_UMyObject();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMyObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMyObject_MyFunction, "MyFunction" }, // 2342311421
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMyObject_Statics::NewProp_MyFloat = { "MyFloat", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMyObject, MyFloat), METADATA_PARAMS(Z_Construct_UClass_UMyObject_Statics::NewProp_MyFloat_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMyObject_Statics::NewProp_MyFloat_MetaData)) };
	...
	IMPLEMENT_CLASS(UMyObject, 3480492008);
	template<> FIRST_GAME_PROJECT_API UClass* StaticClass<UMyObject>()
	{
		return UMyObject::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyObject(Z_Construct_UClass_UMyObject, &UMyObject::StaticClass, TEXT("/Script/First_Game_Project"), TEXT("UMyObject"), false, nullptr, nullptr, nullptr);
